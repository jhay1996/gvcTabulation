...
<body data-spy="scroll" data-target=".bs-docs-sidebar">
  ...
  <!-- Navbar
    ================================================== -->
  <div class="navbar navbr-inverse navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
        ...
        <a class="brand" href="#" style="color:black"><img src="img/gvc.png" width="23" height="23" />&nbsp; <font size="3">GVCFI | Tabulation System</font></a>
  ...
  <header class="jumbotron subhead" id="overview">
    <div class="container">
      ...
      <p class="lead">Tabulation System</p>
    </div>
  </header>
    ...
    <div class="span12">
      ...
      <form method="POST">
        ...
        <div id="myGroup">
          ...
          <a class="btn btn-success" style="margin-bottom: 4px !important;" data-toggle="collapse"
            data-target="#contestant" data-parent="#myGroup"><i class="icon-chevron-right"></i>
            <strong>CONTESTANT</strong></a>

          <a class="btn btn-success" style="margin-bottom: 4px !important;" data-toggle="collapse" data-target="#judges"
            data-parent="#myGroup"><i class="icon-chevron-right"></i> <strong>JUDGE</strong></a>

          <a class="btn btn-success" style="margin-bottom: 4px !important;" data-toggle="collapse" data-target="#criteria"
                ...
                <div class="page-header">
                  <h1>Contestant's Settings
                    &nbsp;<a title="Click to add new Contestant for this Event"
                      ...
                      class="btn btn-success"><i class="icon icon-plus"></i></a>
                  </h1>
                </div>
                ...
                <div class="page-header">
                  <h1>Judge's Settings
                    ...
                    &nbsp;<a title="Click to print Judge's Code for this Event" target="_blank"
                      ...
                      class="btn btn-success"><i class="icon icon-print"></i></a></h1>
                </div>
                <table class="table table-bordered">
                  <thead>
                    <th>Check to Select</th>
      ...
      <section id="download-bootstrap">
        <div class="page-header">
          <h1>Criteria's Settings &nbsp;<a title="Click to add new Criteria for this Event"
              ...
              class="btn btn-success"><i class="icon icon-plus"></i></a></h1>
        </div>
        <table class="table table-bordered">
          <thead>
            <th>Check to Select</th>
