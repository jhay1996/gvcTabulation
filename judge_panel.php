...
<head>
  ...
  <body>
    ...
    <!-- Navbar
    ================================================== -->
    <div class="navbar navar-inverse navbar-fixed-top">
         ...
         <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li>
                ...
                <li>
                <a href="#">   
                <font color="black">Event: <strong><?php echo $se_namexx; ?></strong></font>  
                </a>
              </li>
              
                <li>
                <a href="#">
                <font color="black">Judge: <strong><?php echo $j_name; ?>&nbsp;&nbsp;&nbsp;<?php echo $jtype; ?> </strong></font>
                </a>
              </li>
...
<!-- Subhead
================================================== -->
<table style="background-color: green; width: 100% !important; height: 150px; text-indent: 25px;" align="center" border="0">
<tr>
<td>
<h1 style="color: whitesmoke !important;">Judge's Panel</h1>
<h4 style="color: whitesmoke !important;">Tabulation System</h4>
</td>
</tr>
</table>
                   ...
                   <a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=allTally">View Tally</a>  
                     <?php  } 
                                        ...
                                        <div class="container">
                                          ...
                                          <font size="4">Tabulation System &middot; &COPY; <?= date ("Y") ?></font>
                                          <hr />
                                          ...
                                          <tr>
                                          <td align="center"><img src="img/gvc.png" width="35" height="35" /></td>
                                         </tr>
                                         <tr>
                                          <td align="center">
