        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#"><img src="uploads/<?php echo $company_logo; ?>" width="23" height="23" />&nbsp; <font size="3">Tabulation System</font></a>
...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    ...
    <form method="POST" target="_self" action="review_search.php">
     ...
     <br />
      <button class="btn btn-success pull-right" style="width: 150px !important;"><i class="icon-search"></i> <strong>SEARCH</strong></button> 
 ...
 <div class="panel panel-primary">
  ...
  <?php if($mainevent_query->rowCount()>0){ ?>
    <button class="btn btn-success pull-right" style="width: 200px !important;"><strong>NEXT</strong> <i class="icon-chevron-right"></i></button></td>
