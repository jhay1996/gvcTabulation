        ...
        <div class="container" style="background-color: darkgreen;">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#"><img src="img/gvc.png" width="23" height="23" />&nbsp; <font size="3">GVCFI | Tabulation System </font></a>
...
<header class="jumbotron subhead" id="overview">
 ...
 <div id="myGroup">
             ...
             <button class="btn btn-success" data-toggle="collapse" data-target="#organizer" data-parent="#myGroup"><i class="icon-chevron-right"></i> <strong>ORGANIZER</strong></button>
  ...
  <div class="input-group">
                ...
                <div class="alert alert-success alert-organizer-login">
     ...
     <input class="form-control" name="check_pass" type="hidden" value="<?php echo $check_pass; ?>" />
      ...
      <h4>Organizer's Password</h4>
       ...
       <div class="pull-right">
         <button class="btn btn-success" type="reset"><i class="icon-ban-circle"></i> <strong>CLEAR</strong></button>&nbsp;
